...
import com.alaka_ala.unofficial_kinopoisk_api.constants.ImageType;
...
import com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelOrPrequel;
...
public class KinopoiskApiClientV2 {
    ...
    public void getStaff(int kinopoiskId, boolean forceRefresh, ApiCallback<List<Staff>> callback) {
        ...
        executor.execute(() -> {
            ...
            makeRequest(url, new TypeToken<List<com.alaka_ala.unofficial_kinopoisk_api.models.Staff>>() {}.getType(), new ApiCallback<List<com.alaka_ala.unofficial_kinopoisk_api.models.Staff>>() {
                @Override
                public void onSuccess(List<com.alaka_ala.unofficial_kinopoisk_api.models.Staff> result) {
                    if (result != null) {
                        executor.execute(() -> {
                            com.alaka_ala.unofficial_kinopoisk_api.models.StaffResponse response = new com.alaka_ala.unofficial_kinopoisk_api.models.StaffResponse();
                ...
                public void onError(ApiException error) {
                    executor.execute(() -> {
                        com.alaka_ala.unofficial_kinopoisk_api.models.StaffResponse cached = database.staffDao().getById(staffId);
                        if (cached != null) {
                            callback.onSuccess(cached.getItems());
                        } else {
                            callback.onError(error);
    ...
    public void getGenreOrCountryList(ApiCallback<FilmCountryOrGenresResponse> callback) {
        executor.execute(() -> {
            com.alaka_ala.unofficial_kinopoisk_api.models.FilmCountryOrGenresResponse cached = database.filmCountryOrGenresResponseDao().getResponse(GENRES_COUNTRIES_ID);
            if (cached != null) {
                callback.onSuccess(cached);
                return;
            }
            String url = BASE_URL + "v2.2/films/filters";
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmCountryOrGenresResponse.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmCountryOrGenresResponse>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmCountryOrGenresResponse result) {
                    if (result != null) {
                        executor.execute(() -> {
    ...
    public void getFilmDetails(int kinopoiskId, boolean forceRefresh, ApiCallback<FilmDetails> callback) {
        executor.execute(() -> {
            if (!forceRefresh) {
                com.alaka_ala.unofficial_kinopoisk_api.models.FilmDetails cached = database.filmDetailsDao().getById(kinopoiskId);
                if (cached != null && (System.currentTimeMillis() - cached.getLastUpdated()) < CACHE_DURATION_MS) {
            ...
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmDetails.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmDetails>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmDetails result) {
                    if (result != null) {
                        executor.execute(() -> {
                            com.alaka_ala.unofficial_kinopoisk_api.models.FilmDetails cached = database.filmDetailsDao().getById(kinopoiskId);
                            if (cached != null) {
    ...
    public void getFilmSimilar(int kinopoiskId, boolean forceRefresh, ApiCallback<FilmSimilarResponse> callback) {
        ...
        executor.execute(() -> {
            if (!forceRefresh) {
                com.alaka_ala.unofficial_kinopoisk_api.models.FilmSimilarResponse cached = database.filmSimilarResponseDao().getById(similarId);
                if (cached != null && (System.currentTimeMillis() - cached.getLastUpdated()) < CACHE_DURATION_MS) {
                    callback.onSuccess(cached);
                    return;
                }
            ...
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmSimilarResponse.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmSimilarResponse>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmSimilarResponse result) {
                    if (result != null) {
                        executor.execute(() -> {
    ...
    public void getFilmImages(int kinopoiskId, ImageType type, int page, boolean forceRefresh, ApiCallback<FilmImagesResponse> callback) {
        ...
        executor.execute(() -> {
            if (!forceRefresh) {
                com.alaka_ala.unofficial_kinopoisk_api.models.FilmImagesResponse cached = database.filmImagesResponseDao().getById(imageId);
                if (cached != null && (System.currentTimeMillis() - cached.getLastUpdated()) < CACHE_DURATION_MS) {
                    callback.onSuccess(cached);
                    return;
                }
            ...
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmImagesResponse.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmImagesResponse>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmImagesResponse result) {
                    if (result != null) {
                        executor.execute(() -> {
    ...
    public void getFilmSequelsAndPrequels(int kinopoiskId, boolean forceRefresh, ApiCallback<List<FilmSequelOrPrequel>> callback) {
        ...
        executor.execute(() -> {
            ...
            makeRequest(url, new TypeToken<List<com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelOrPrequel>>() {}.getType(), new ApiCallback<List<com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelOrPrequel>>() {
                @Override
                public void onSuccess(List<com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelOrPrequel> result) {
                    if (result != null) {
                        executor.execute(() -> {
                            com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelsAndPrequelsResponse response = new com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelsAndPrequelsResponse();
                ...
                public void onError(ApiException error) {
                    executor.execute(() -> {
                        com.alaka_ala.unofficial_kinopoisk_api.models.FilmSequelsAndPrequelsResponse cached = database.filmSequelsAndPrequelsResponseDao().getById(sequelsId);
                        if (cached != null) {
                            callback.onSuccess(cached.getItems());
                        } else {
                            callback.onError(error);
    ...
    public void searchFilmByKeyword(String keyword, int page, boolean forceRefresh, ApiCallback<FilmSearchResponse> callback) {
        ...
        executor.execute(() -> {
            if (!forceRefresh) {
                com.alaka_ala.unofficial_kinopoisk_api.models.FilmSearchResponse cached = database.filmSearchResponseDao().getById(searchId);
                if (cached != null && (System.currentTimeMillis() - cached.getLastUpdated()) < CACHE_DURATION_MS) {
                    callback.onSuccess(cached);
                    return;
                }
            ...
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmSearchResponse.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmSearchResponse>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmSearchResponse result) {
                    if (result != null) {
                        executor.execute(() -> {
                            result.setId(searchId);
                            result.setLastUpdated(System.currentTimeMillis());
    ...
    public void getFilmFacts(int kinopoiskId, boolean forceRefresh, ApiCallback<FilmFactsResponse> callback) {
        ...
        executor.execute(() -> {
            if (!forceRefresh) {
                com.alaka_ala.unofficial_kinopoisk_api.models.FilmFactsResponse cached = database.filmFactsResponseDao().getById(factsId);
                if (cached != null && (System.currentTimeMillis() - cached.getLastUpdated()) < CACHE_DURATION_MS) {
                    callback.onSuccess(cached);
                    return;
                }
            ...
            makeRequest(url, com.alaka_ala.unofficial_kinopoisk_api.models.FilmFactsResponse.class, new ApiCallback<com.alaka_ala.unofficial_kinopoisk_api.models.FilmFactsResponse>() {
                @Override
                public void onSuccess(com.alaka_ala.unofficial_kinopoisk_api.models.FilmFactsResponse result) {
                    if (result != null) {
                        executor.execute(() -> {
